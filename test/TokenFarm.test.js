...
contract('TokenFarm', ([owner, investor]) => {
  ...
  describe('Farming tokens', async () => {
    ...
    it('rewards investors for staking mDai tokens', async () => {
      ...
      assert.equal(result.toString(), tokens('100'), 'investor DApp Tokens correct after issuance')
      ...
      result = await tokenFarm.stakingBalance(investor)
      assert.equal(result, tokens('0'), 'investor staking balance correct after unstaking')
